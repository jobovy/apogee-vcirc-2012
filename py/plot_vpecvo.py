...
from fitvc import _REFV0, _REFR0, _PMSGRA
def plot_vpecvo(filename,plotfilename):
    ...
    axScatter, axHistx,axHisty= bovy_plot.scatterplot(vos/ros+vpec/ros,vpec,'k,',levels=levels,
    ...
    bovy_plot.bovy_text(25.5,12.5,r'$\mathrm{SBD10}$')
