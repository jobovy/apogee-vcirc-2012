...
def mloglike(params,vhelio,l,b,jk,h,df,options,sinl,cosl,cosb,sinb,
    ...
    if options.dwarf and (params[5-options.nooutliermean] < 0. or params[5-options.nooutliermean] > 1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitsratio and params[5+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf-options.nooutliermean] < 0.:
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitsratioinnerouter and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf] < 0. or params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf] < 0.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitdm and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter] > 1. or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter] < -1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitah and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter] < -0.2 or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter] > 0.4):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitfeh and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter] > 1. or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter] < -1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitdminnerouter and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitah+options.fitdm+options.fitfeh+options.fiths] > 1. or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitah+options.fitdm+options.fitfeh+options.fiths] < -1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitahinnerouter and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter] < -0.2 or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter] > 0.4):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitfehinnerouter and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitah+options.fitdm+options.fitfeh+options.fiths] > 1. or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitah+options.fitdm+options.fitfeh+options.fiths] < -1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.fitm2 and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths] < 0. or params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths] < -0.5 or params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths] > 0.5):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.dwarfinnerouter and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths+options.fitsrinnerouter] < 0. or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths+options.fitsrinnerouter] > 1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    if options.dfmodel.lower() == 'twopops' and (params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter] <= 0. or params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter] >= 1.):
        return numpy.finfo(numpy.dtype(numpy.float64)).max
    ...
    if options.dontbintegrate:
        ...
        if options.dfmodel.lower() == 'dehnen':
            ...
            if options.fiths: thishs= options.hs/params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter]
        ...
        for ii in range(len(vhelio)):
            if options.dwarf: #Combine
                ...
                if options.dwarfinnerouter and l[ii] < 97.*_DEGTORAD:
                    tmpthisout+= -numpy.log(1.-params[5-options.nooutliermean])+numpy.log(1.-params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.fitdm+options.fitah+options.fitfeh])
                thislogpdwarf= logpddwarf[ii,0]
                tmpthisxtraout= thisxtraout[ii,0]+numpy.log(params[5-options.nooutliermean])-thislogpdwarf
                if options.dwarfinnerouter and l[ii] < 97.*_DEGTORAD:
                    tmpthisxtraout+= -numpy.log(params[5-options.nooutliermean])+numpy.log(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.fitdm+options.fitah+options.fitfeh])
...
def _mloglikedIntegrand(d,params,vhelio,l,b,jk,h,
    ...
    #Re-calculate logpiso if necessary
        ...
        dm= _dm(d*params[1]*_REFR0)\
            -params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter]
        if options.fitdminnerouter: dminnerouter= _dm(d*params[1]*_REFR0)\
                -params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh]
        for ii in range(len(vhelio)):
            mh= h[ii]-dm
        ...
        ah= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter]
        if options.fitahinnerouter: ahinnerouter= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitah+options.fitdm+options.fitfeh]
        dm= _dm(d*params[1]*_REFR0)
        for ii in range(len(vhelio)):
            mh= h[ii]-dm+ah
            if options.indivfeh:
        ...
        dm= _dm(d*params[1]*_REFR0)
        dfeh= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter]
        if options.fitfehinnerouter: dfehinnerouter= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh]
        for ii in range(len(vhelio)):
            mh= h[ii]-dm
            if options.indivfeh:
                #Find closest Z
...
def _logpddf(params,d,l,b,R,theta,cosb,sinb,options):
    ...
    if options.dfmodel.lower() == 'twopops':
        ...
        hrpops= [options.hr,
                 options.hr2]
        ppops= numpy.log(numpy.array([1.-params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fitfehinnerouter],
                                      params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fitfehinnerouter]]))
...
def _logdf(params,vpec,R,options,df,l,theta,vcf):
    ...
    thishs= options.hs
    if options.fiths: thishs/= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh]
    if options.dfmodel.lower() == 'simplegaussian':
        if options.fitsratio:
            slos= numpy.exp(params[2])/params[0]\
                *numpy.sqrt(1.+sinlt**2.*(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R-1.)/thishs*params[1]*_REFR0)
        elif options.fitsratioinnerouter:
            innerl= (l < 97.*_DEGTORAD)
            slos= numpy.exp(params[2])/params[0]\
                *numpy.sqrt(1.+sinlt**2.*(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R-1.)/thishs*params[1]*_REFR0)
            slos[innerl]= numpy.exp(params[2])/params[0]\
                *numpy.sqrt(1.+sinlt[innerl]**2.*(params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R[innerl]-1.)/thishs*params[1]*_REFR0)
        else:
            slos= numpy.exp(params[2])/params[0]\
        ...
        if options.fitsratio:
            ...
            if options.fitsrinnerouter and not numpy.all(R == 1.): #Don't do this for dwarfs
                innerl= (l < 97.*_DEGTORAD)
                slos[innerl]*= numpy.exp(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths])
                va[innerl]= asymmetricDriftModel.va(R[innerl],numpy.exp(params[2]+params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths])/params[0],
                                                    hR=options.hr/params[1]/_REFR0,
                                                    hs=thishs/params[1]/_REFR0,
        ...
        for ii in range(_NMULTIPLEPOPS):
            ...
            if options.fitsratio:
                slos= numpy.exp(params[2])/params[0]\
                    *numpy.sqrt(1.+sinlt**2.*(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R-1.)/thishs*params[1]*_REFR0)*sigmapops[ii]
            elif options.fitsratioinnerouter:
                innerl= (l < 97.*_DEGTORAD)
                slos= numpy.exp(params[2])/params[0]\
                    *numpy.sqrt(1.+sinlt**2.*(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R-1.)/thishs*params[1]*_REFR0)*sigmapops[ii]
                slos[innerl]= numpy.exp(params[2])/params[0]\
                    *numpy.sqrt(1.+sinlt[innerl]**2.*(params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R[innerl]-1.)/thishs*params[1]*_REFR0)*sigmapops[ii]
            else:
                slos= numpy.exp(params[2])/params[0]\
        ...
        sigmapops= [numpy.exp(params[2])/params[0],
                    numpy.exp(params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fitfehinnerouter])/params[0]]
        ppops= numpy.log(numpy.array([1.-params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fitfehinnerouter],
                                      params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fiths+options.fitsrinnerouter+options.dwarfinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fitfehinnerouter]]))
        ...
        for ii in range(npops):
            ...
            #va= vc- <v>
            if options.fitsratio:
                slos= numpy.sqrt(1.+sinlt**2.*(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R-1.)/thishs*params[1]*_REFR0)*sigmapops[ii]
            elif options.fitsratioinnerouter:
                innerl= (l < 97.*_DEGTORAD)
                slos= numpy.sqrt(1.+sinlt**2.*(params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]-1.))*numpy.exp(-(R-1.)/thishs*params[1]*_REFR0)*sigmapops[ii]
        ...
        #va= vc- <v>
        alphaskew= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter]
        ...
        if options.fitsratio:
            sigmaT2= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]*sigmaR2
        elif options.fitsratio:
            innerl= (l < 97.*_DEGTORAD)
            sigmaT2= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]*sigmaR2
            sigmaT2[innerl]= params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf]*sigmaR2[innerl]
        else:
            sigmaT2= 0.5*sigmaR2
...
def _vpec(params,vgal,R,options,l,theta,vcf):
    if options.fitm2:
        eps= params[5-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths]
        phio= math.pi*params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+2*options.fitvpec+options.dwarf+options.fitsratio+2*options.fitsratioinnerouter+options.fitdm+options.fitah+options.fitfeh+options.fiths]
...
def _vgal(params,vhelio,l,b,options,sinl,cosl):
    if options.fitvpec:
        return vhelio-params[5-options.nooutliermean+options.dwarf+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')]*cosl*_VRSUN/params[0]/_REFV0\
            +params[6-options.nooutliermean+(options.rotcurve.linear.lower() == 'linear')+(options.rotcurve.lower() == 'flatplusuniform') +(options.rotcurve.lower() == 'powerlaw') + 2*(options.rotcurve.lower() == 'quadratic')+3*(options.rotcurve.lower() == 'cubic')+options.dwarf]*sinl*_PMSGRA*params[1]*_REFR0/params[0]/_REFV0 #params[1]=Ro
